            ...
            try
            {
                if (intent != null)
                {
                    if (intent.HasExtra("NavigationID"))
                    {
                        ...
                        {
                            _preferences.SetValue("NavigationID", navigationId);
                            _logger.LogInformation("NavigationID successfully stored in preferences.");
                            OnResume();
                        }
                        else
                        {
                ...
                {
                    _logger.LogInformation("Intent is null.");
                }
            }
            catch (Exception ex)
            {
